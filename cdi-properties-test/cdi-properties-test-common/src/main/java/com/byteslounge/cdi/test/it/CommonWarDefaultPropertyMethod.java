 ...
 * @since 1.0.0
 */
public class CommonWarDefaultPropertyMethod extends AbstractWarDefaultPropertyMethod {

    public static WebArchive createArchive() throws IOException {
        WebArchive webArchive = AbstractWarDefaultPropertyMethod.createArchive();
        return webArchive;
    }
