...
import com.byteslounge.cdi.test.common.filter.LocaleFilterPT;
 ...
 * @since 1.1.0
 */
public class CommonWarProvidedLocaleMethodThreadLocalPT extends AbstractWarProvidedLocaleMethodThreadLocal {
