...
public class WarDefaultPropertyProvidedLocaleMethodAllIT extends AbstractWarDefaultPropertyMethod {
    ...
    public static WebArchive createArchive() throws IOException {
        WebArchive webArchive = CommonWarDefaultPropertyProvidedLocaleMethodAll.createArchive();
        ...
        IntegrationTestDeploymentUtils.addGlassfishResources(webArchive);
        return webArchive;
    }
