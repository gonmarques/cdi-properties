...
public class WarDefaultPropertyProvidedLocaleMethodAllIT extends AbstractWarDefaultPropertyMethodIT {
    ...
    public static WebArchive createArchive() throws IOException {
        ...
        DeploymentClassAppenderFactory.create(webArchive)
                .append("com.byteslounge.cdi.test.wpm.ProvidedLocaleMethodResolver")
                ...
                .append("com.byteslounge.cdi.test.common.DependentScopedBean").appendPersistenceXml();
