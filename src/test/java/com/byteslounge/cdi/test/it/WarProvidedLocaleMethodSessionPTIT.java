...
import com.byteslounge.cdi.test.it.common.AbstractWarProvidedLocaleMethodSessionIT;
...
public class WarProvidedLocaleMethodSessionPTIT extends AbstractWarProvidedLocaleMethodSessionIT {
    ...
    public static WebArchive createArchive() throws IOException {
        ...
        WebArchive webArchive = AbstractWarProvidedLocaleMethodSessionIT.createArchive();
        DeploymentClassAppenderFactory.create(webArchive).append(
                "com.byteslounge.cdi.test.common.filter.LocaleSessionFilterPT");
