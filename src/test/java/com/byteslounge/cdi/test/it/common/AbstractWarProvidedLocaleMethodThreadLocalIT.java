 ...
 * @since 1.1.0
 */
public abstract class AbstractWarProvidedLocaleMethodThreadLocalIT {
    ...
    protected static WebArchive createArchive() throws IOException {
        ...
        DeploymentClassAppenderFactory.create(webArchive)
                .append("com.byteslounge.cdi.test.wpm.ProvidedLocaleMethodResolverThreadLocal")
                ...
                .append("com.byteslounge.cdi.test.common.LocaleThreadLocal")
