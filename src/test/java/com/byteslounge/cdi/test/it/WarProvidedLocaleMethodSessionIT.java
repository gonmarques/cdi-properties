...
public class WarProvidedLocaleMethodSessionIT extends AbstractWarProvidedLocaleMethodSessionIT {
    ...
    public static WebArchive createArchive() throws IOException {
        ...
        DeploymentClassAppenderFactory.create(webArchive).append(
                "com.byteslounge.cdi.test.common.filter.LocaleSessionFilter");
