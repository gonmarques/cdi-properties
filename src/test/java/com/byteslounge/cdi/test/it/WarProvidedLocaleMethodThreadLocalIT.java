...
public class WarProvidedLocaleMethodThreadLocalIT extends AbstractWarProvidedLocaleMethodThreadLocalIT {
    ...
    public static WebArchive createArchive() throws IOException {
        ...
        DeploymentClassAppenderFactory.create(webArchive).append("com.byteslounge.cdi.test.common.filter.LocaleFilter");
