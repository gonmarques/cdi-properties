...
/**
 * Represents the extractor for the Bundle property resolver method parameter
 * 
 * @author Gonçalo Marques
 * @since 1.1.0
 */
public class BundleResolverParameterExtractor extends
        ProvidedResolverParameterExtractor<BundlePropertyResolverParameter> {
